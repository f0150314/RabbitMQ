...
namespace DirectReceiver.Services;

internal class RabbitMqDirectReceiverService : RabbitMqReceiverAbstractService
{
    public RabbitMqDirectReceiverService(IRabbitMqConnectionFactory rabbitMqConnectionFactory, IValidation validation)
