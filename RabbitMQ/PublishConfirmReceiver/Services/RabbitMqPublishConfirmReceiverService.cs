...
namespace PublishConfirmReceiver.Services;

internal class RabbitMqPublishConfirmReceiverService : RabbitMqReceiverAbstractService
{
    public RabbitMqPublishConfirmReceiverService(IRabbitMqConnectionFactory rabbitMqConnectionFactory, IValidation validation)
