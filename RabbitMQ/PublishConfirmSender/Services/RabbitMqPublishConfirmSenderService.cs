...
namespace PublishConfirmSender.Services;

internal class RabbitMqPublishConfirmSenderService : RabbitMqSenderAbstractService
{
    public RabbitMqPublishConfirmSenderService(IRabbitMqConnectionFactory rabbitMqConnectionFactory, IValidation validation)
