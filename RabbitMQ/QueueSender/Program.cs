...
using QueueSender.Factories;
using QueueSender.Services;
...
static IHostBuilder CreateDefaultBuilder() =>
    Host.CreateDefaultBuilder()
        ...
        .ConfigureServices(services =>
        {
            ...
            services.AddScoped(typeof(IRabbitMqConfigFactory<IRabbitMqConfig>), typeof(RabbitMqQueueSenderConfigFactory));
            services.AddScoped<IRabbitMqConnectionFactory, RabbitMqConnectionFactory>();
            services.AddScoped<RabbitMqSenderAbstractService, RabbitMqQueueSenderService>();
        });